...
| 5d. Historique d'un joueur (`GET /players/{id}/games`) | 🚧 En cours | feat/player-history |
...
| `GET /players/{id}/games?mode=&limit=` | Historique des games terminées du joueur, DESC sur `finished_at`. `mode` optionnel, `limit ∈ [1, 100]` (défaut `20`). | `200` (liste vide si pas de games) ou `404` (joueur inconnu) |
